...
class MessagesController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{	
			$model->messageTitle = $_POST['MessageForm']['messageTitle'];
			$model->messageContent = $_POST['MessageForm']['messageContent'];
			$model->receiverEmail = $_POST['MessageForm']['receiverEmail'];
			//$model->attributes = $_POST['MessageForm'];
			if($model->saveAndSend())
